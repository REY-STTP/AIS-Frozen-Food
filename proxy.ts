...
export const config = {
  matcher: ["/((?!_next/static|_next/image|favicon.ico|icon.png|logo.png|apple-icon.png|opengraph-image|gallery|products|robots.txt|sitemap.xml|llms.txt|llms-full.txt|manifest.json|sw.js).*)"],
};
